...
public class FormularioEstudio extends javax.swing.JFrame {
    ...
    jPanelMostrarEstudios.setVisible(true);
      ...
      private void initComponents() {
            ...
            getContentPane().add(jPanelMostrarEstudios, java.awt.BorderLayout.CENTER);

            jPanelBusquedas.setLayout(new javax.swing.OverlayLayout(jPanelBusquedas));

            jPanelBuscarEstudioEstado.setBackground(new java.awt.Color(153, 204, 255));
            jPanelBuscarEstudioEstado.setPreferredSize(new java.awt.Dimension(790, 427));
            ...
            jPanelBusquedas.add(jPanelBuscarEstudioEstado);

            jPanelBuscarEstudioFechaRec.setBackground(new java.awt.Color(153, 204, 255));
            jPanelBuscarEstudioFechaRec.setPreferredSize(new java.awt.Dimension(790, 427));
            ...
            jPanelBusquedas.add(jPanelBuscarEstudioFechaRec);

            jPanelBuscarEstudioPro.setBackground(new java.awt.Color(153, 204, 255));
            jPanelBuscarEstudioPro.setPreferredSize(new java.awt.Dimension(790, 427));
            ...
            jPanelBuscarEstudioProLayout.setHorizontalGroup(
                  ...
                  .addGroup(jPanelBuscarEstudioProLayout.createSequentialGroup()
                        .addGroup(jPanelBuscarEstudioProLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                              .addGroup(jPanelBuscarEstudioProLayout.createSequentialGroup()
                                    .addGap(215, 215, 215)
                              ...
                              .addGroup(jPanelBuscarEstudioProLayout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanelBuscarEstudioProLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                          ...
                                          .addGroup(jPanelBuscarEstudioProLayout.createSequentialGroup()
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(matProEstInput, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)))))
            ...
            jPanelBusquedas.add(jPanelBuscarEstudioPro);
            ...
            estadoEst.setBackground(new java.awt.Color(0, 51, 102));
            ...
            jPanelBusquedas.add(jPanelModificarEst);

            getContentPane().add(jPanelBusquedas, java.awt.BorderLayout.PAGE_START);
